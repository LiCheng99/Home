...
let bg_img_preinstall = {
    ...
    "3": "https://myhkw.cn/open/img/scen", // 随机风景   用户：https://myhkw.cn/密钥：c206e987df83447da0659ab5fc0fea7a
    "4": "https://myhkw.cn/open/img/acg" ,// 随机动漫  用户：https://myhkw.cn/密钥：c206e987df83447da0659ab5fc0fea7a
	"5": "https://v.api.aa1.cn/api/pc-girl_bz/index.php?wpon=ro38d57y8rhuwur3788y3rd" // 随机美女
};
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        ...
        case "2":
            ...
            break;
        case "3":
            $('#bg').attr('src', 'https://myhkw.cn/open/img/scen'); //随机风景
            break;
        case "4":
            $('#bg').attr('src', 'https://myhkw.cn/open/img/acg'); //随机动漫
            break;
		case "5":
		    $('#bg').attr('src', 'https://myhkw.cn/open/img/mm'); //随机美女
		    break;
    }
};
