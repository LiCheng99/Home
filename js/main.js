...
setTimeout(function () {
    $('#loading-text').html("别着急,加载亿小会儿就好啦~")
}, 3000);
...
const add_id = "hmkrjspkvzxqesnw"; // app_id
const app_secret = "dmwrejRkSkQ1VndXNm83NFZmRm81dz09"; // app_secret
const key = "8b183390be0d42d7b23bc0a324b72741" // key
function getWeather() {
...
$("#wechat").mouseover(function () {
    $("#link-text").html("朋友圈没我的帅照");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#qq").mouseover(function () {
    $("#link-text").html("00年的QQ号");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
